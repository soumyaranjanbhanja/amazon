...
app.post('/api/users/Signup', async (req, res) => {
  try {
    ...
    db.query('SELECT * FROM tiger WHERE email = ?', [email], async (selectErr, selectResults) => {
      if (selectErr) {
      ...
      db.query('INSERT INTO tiger (email, password) VALUES (?, ?)', [email, hashedPassword], (insertErr, insertResults) => {
        if (insertErr) {
...
app.post('/api/users/Login', async (req, res) => {
  try {
    ...
    db.query('SELECT * FROM tiger WHERE email = ?', [email], async (err, results) => {
      if (err) {
